...
<head>
    ...
    <style>
        body {
            background-color: rgb(252, 201, 226) !important; 
            margin: 0;
            padding: 0;
        }
    </style>
...
<body>
    ...
    <div class="container-fluid">
        <span class="glyphicon glyphicon-heart-empty"></span>: Hearty<br/>
        <span class="glyphicon glyphicon-font"></span>: Lyrine<br/>
    ...
    <div class="container-fluid">
        <img src="pic/marie.png">
        <img src="pic/marie.png" class="img-rounded">
        <img src="pic/marie.png" class="img-circle">
        <img src="pic/marie.png" class="img-thumbnail">
    </div>

    <!-- jQuery and Bootstrap JS (correct versions) -->
