...
<head>
    ...
    <style>
        body {
            background-color: rgb(252, 201, 226);
            margin: 0;
            padding: 0;
        }
    </style>
...
<div class="container-fluid">
    ...
    <div class="tab-content">
        <div class="tab-pane fade active" id="p1">Welcome to Home</div>
    ...
    <div class="tab-content">
        <div class="tab-pane fade active" id="t1">Welcome to Home</div>
...
<hr/> 
 ...
 <div class="container-fluid">
    ...
    <ul class="nav nav-tabs">
        <li><a href="#">Home</a></li>
        <li class="active"><a href="#">HTML</a></li>
        <li class="dropdown"><a clss="dropdown-toggle" href="#" data-toggle="dropdown">PHP<span class="caret"></span></a>
        <ul class="dropdown-menu">
        <li><a href="#">PHP-Function</a></li>
        <li><a href="#">PHP-MYSQL</a></li>
        <li><a href="#">PHP-Loop</a></li>
...
<hr/>
    <div class="container">
    <button class="btn btn-info" data-toggle="collapse" data-target="#dtx">Click to Collapse Pic</button>
        <button class="btn btn-primary" data-toggle="collapse" data-target="#dty">Click to Collapse</button>
        <div id="dty" class="collapse">
            The data to be collapsed is in here...
        </div>
        <div id="dtx" class="collapse"><img src="luna.png.NEF">
        </div>
    </div>   
<br/>
<br/>
